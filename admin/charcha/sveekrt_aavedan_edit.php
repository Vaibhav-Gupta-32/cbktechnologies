    ...
    <div class="container-fluid pt-4 px-4 ">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group shadow">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="saral_aadesh_no" placeholder="सरल आदेश क्र." required name="saral_aadesh_no" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?= $saral_aadesh_no ?>" readonly>
                        <label for="saral_aadesh_no">सरल आदेश क्र.  </label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group shadow">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="saral_aadesh_no" placeholder="अनुमोदित राशि" required name="anumodit_amount" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?=$anumodit_amount?>">
