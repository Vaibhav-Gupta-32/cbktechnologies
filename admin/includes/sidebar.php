         ...
         <div class="navbar-nav w-100">
             ...
             <div class="nav-item dropdown">
              ...
              <div class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu bg-transparent border-0">
                     <a href="../chikitsa_seva/new_chikitsa_seva.php" class="dropdown-item"><b>नया आवेदन जोड़ें </b></a>
             ...
             <div class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu bg-transparent border-0">
                     ...
                     <a href="../protocol/sveekrt_aavedan.php" class="dropdown-item"><b>स्वीकृत आवेदन</b></a>
                     <!-- <a href="../chikitsa/prastavit_aavedan.php" class="dropdown-item"><b>प्रस्तावित आवेदन</b></a> -->
                     <!-- <a href="../chikitsa/presit_aavedan.php" class="dropdown-item"><b>स्वीकृत आवेदन ( प्रेषित )</b></a>
                     <a href="../chikitsa/asveekrt_aavedan.php" class="dropdown-item"><b>अस्वीकृत आवेदन</b></a> -->
                 </div>
             ...
             <div class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu bg-transparent border-0">
                     ...
                     <!-- <a href="../aamantran/prastavit_aavedan.php" class="dropdown-item"><b>प्रस्तावित आवेदन</b></a> -->
                     <a href="../aamantran/sveekrt_aavedan.php" class="dropdown-item"><b>स्वीकृत आवेदन</b></a>
                     <!-- <a href="../aamantran/presit_aavedan.php" class="dropdown-item"><b>स्वीकृत आवेदन ( प्रेषित )</b></a> -->
             ...
             <div class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu bg-transparent border-0">
                     ...
                     <a href="../master/hospital_master.php" class="dropdown-item">हॉस्पिटल मास्टर</a>
                 </div>
             </div>
             <!-- सेटिंग्स -->
             <div class="nav-item dropdown">
