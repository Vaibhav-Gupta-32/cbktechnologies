...
_name" class="form-control border-success" placeholder="निर्माण के प्रकार
 का नाम" required>
            ...
            <div class="col-lg-4 text-center mb-3">
                <button name="submit_nirmaan_type
" class="form-control text-center text-white btn  text-center shadow" type="submit" style="background-color:#4ac387;"><b>Save</b></button>
            </div>
            <div class="col-lg-4 text-center mb-3">
                <button name="cancel_nirmaan_type
" class="form-control text-center text-white btn  text-center shadow" type="reset" style="background-color:#57c2fc;"><b>Cancel</b></button>
            </div>
        </div>
    </form>
 ...
 Name -->
        <div class="row text-center align-items-center">
            ...
            <input type="hidden" name="nirmaan_type
_id" id="nirmaan_type
_id">
            <div class="col-lg-4 text-center mb-3">
                <input type="text" name="nirmaan_type
_name" id="edit_nirmaan_type
_name" class="form-control border-success" placeholder="निर्माण के प्रकार
 का नाम" required>
            </div>
            <div class="col-lg-4 text-center mb-3">
                <button name="edit_nirmaan_type
" class="form-control text-center text-white btn text-center shadow" type="submit" style="background-color:#4ac387;"><b>Update</b></button>
            </div>
            <div class="col-lg-4 text-center mb-3">
