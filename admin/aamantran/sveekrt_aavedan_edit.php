...
if (isset($_REQUEST['edit_id'])) {
    ...
    if ($edit_id) {
        $sql = "SELECT * FROM $tblname WHERE $tblkey = '$edit_id' AND status = 1";
    ...
    <div class="container-fluid pt-4 px-4 ">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <div class="form-group shadow">
                    <div class="form-floating mb-3">
                        <textarea class="form-control" id="comment" placeholder="टिप्पणी" readonly required name="comment"><?= $comment ?></textarea>
            ...
            <div class="col-lg-12">
                <div class="form-group shadow">
                    <div class="form-floating mb-3">
                        <textarea class="form-control" id="comment" placeholder="टिप्पणी" required style="height: 150px;" name="comment"><?= $view_comment ?></textarea>
                        <label for="comment">टिप्पणी <span class="text-danger">*</span> </label>
                    </div>
                </div>
            </div>
