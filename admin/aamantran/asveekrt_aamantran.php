...
$tblname = "aamantran";
$tblkey = "id";
$pagename = "अस्वीकृत आमंत्रण आवेदन";
// $msg="";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['UnApprove'])) {
    $vid = $_REQUEST['id'];
    $view_comment = $_POST['view_comment'];
    $sql = "UPDATE $tblname SET status=2, view_comment='$view_comment' WHERE $tblkey='$vid'";
    if (mysqli_query($conn, $sql)) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM $tblname WHERE status=2";
    ...
    $sql = "SELECT * FROM $tblname WHERE status=2 ORDER BY id DESC";
}
                ...
                <table class="table table-striped border shadow">
                    <thead class=" head">
                        ...
                        <tr class="text-center">
                            ...
                            <th scope="col">अस्वीक्र्ट टिपणी</th>
...
<script>
    function view(v_id) {
        ...
        $.ajax({
            type: 'POST',
            url: 'aamantran_aavedan_view.php',
            data: {
                id: v_id
            },
