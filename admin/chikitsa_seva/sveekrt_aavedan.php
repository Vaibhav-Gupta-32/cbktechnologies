...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Update'])) {
    ...
    $anumodit_hospital_name = $_POST['anumodit_hospital_name'];
    ...
    if (isset($_POST['edit_id']) && !empty($_POST['edit_id'])) {
        ...
        $update_query = "UPDATE $tblname SET 
                        anumodit_hospital_name='$anumodit_hospital_name'
                        aadesh_no = '$aadesh_no',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
    ...
    LEFT JOIN gram_panchayat_master gp ON a.gram_panchayat_id = gp.gram_panchayat_id
    LEFT JOIN gram_master g ON a.gram_id = g.gram_id
    LEFT JOIN hospital_master h ON h.id = a.anumodit_hospital_id
    WHERE a.status=1
                        ...
                        ?>
                            <tr class=" text-center">
                                ...
                                <td class="action">
                                    ...
                                    &nbsp;
                                    &nbsp;
                                    <a href="print_pdf.php?id=<?= $row['id']; ?>" target='_blank'><i class=" fa fa-solid fa-print" title="स्वीकृत चिकित्सा आवेदन "></i></a>
                                    &nbsp;
                                    <!-- &nbsp;
